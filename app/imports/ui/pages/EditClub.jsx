...
const EditClub = () => {
  ...
  const submit = (data) => {
    const { name, description, image, meetingTime, location, categories, clubID } = data;
    Clubs.collection.update(_id, { $set: { name, description, image, meetingTime, location, categories, clubID } }, (error) => (error ?
